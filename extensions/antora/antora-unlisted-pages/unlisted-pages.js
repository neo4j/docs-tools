module.exports.register = function ({ config }) {
  const { addToNavigation, logLevel = 'info', unlistedPagesHeading = 'Unlisted Pages' } = config
        ...
        versions.forEach(({ name: component, version, navigation: nav, url: defaultUrl }) => {
          ...
          if (unlistedPages.length) {
              ...
              unlistedPages.forEach((page) => {
                  ...
                  logger[logLevel]({ file: page.src, source: page.src.origin }, 'detected unlisted page')
              })
